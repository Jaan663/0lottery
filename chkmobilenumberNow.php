...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTPHEADER => array(
    "authorization: bUeicNlpAyCJbrGsQx5IUnCKHR2JQFleFXYtp5FL5JDapLtJe0X6VeiTxF4e",  //API KEY
    "accept: */*",
...
//   $sql2= mysqli_query($con,"UPDATE `tbl_user` SET `password`='".($fcpassword)."' where `id`='$userid'");
