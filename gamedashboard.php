...
<div class="appHeader1" style="box-shadow:none;background-color:#e0041e !important">
  <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
    <div class="pageTitle">3 Min WinGo.!</div>
  </div>
</div>
...
<div class="vcard" >
  ...
  <div class="appContent3 text-white" style="background-color:#000000 !important">
    <div class="row">
      <div class="col-12">
        <div class="col-12 mb-1" style="font-size:25px;"><br> ₹ <span id="balance"style="font-size: 25px; font-family:Fantasy;"><?php echo number_format(wallet($con,'amount',$userid), 2); ?></span></div>
        <div class="col-12">
          <div> <a href="recharge.php" class="btn btn-sm btn-blue m-0"style="border-radius: 20px 20px 20px 20px; background-color: #ebcb00;"><b>Recharge</b></a> <a  data-toggle="modal" href="#rule" data-backdrop="static" data-keyboard="false" class="btn btn-sm btn-blue" style="border-radius: 20px 20px 20px 20px;background-color:#ebcb00 !important"><b>Read Rule!</b></a><a href="javascript:void(0);" onClick="reloadbtn(<?php echo $userid;?>);" class="reaload text-white pull-right mt-1" onclick="getResultbyCategory(parity,parity)"> <i class="icon ion-md-refresh"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="long mb-3">      
      ...
      <ul class="nav nav-tabs size4" id="myTab3" role="tablist">
        <li class="nav-item"> 
         ...
         <!--Time & Game Id Section-->
         <div class="layout" style="margin:5px 5px 5px 5px; padding:5px 5px 5px 5px; border: 1px solid #ffc107";>
            <div class="gameidtimer">
               <h5 class="text-center" style="color:#ebcb00"><i class="icon ion-md-trophy"></i> <b>Period :</b></h5>
               <h5>
                  <span class="showload">
                     <div class="spinnner-border text-danger" role="status">
                     </div>
                  </span>
                  <h5 id="gameid" class="text-center"><?php echo sprintf("%03d",gameid($con));?></h5>
                  <input type="hidden" id="futureid" name="futureid" value="<?php echo sprintf("%03d",gameid($con));?>">
               </h5>
            </div>
            <div class="gameidtimer text-right">
               <h5 class="text-center" style="color:#ebcb00"><i class="fa fa-clock-o" aria-hidden="true"></i> <b>Timer :</b></h5>
               <h5 class="text-center" id="demo"></h5>
            </div>
         </div>
         <!--Time & Game Id Section End-->
         <br>
