...
WHEN value='0' THEN (amount-(amount/100*5))*9 
WHEN value='1' THEN (amount-(amount/100*5))*9 
WHEN value='2' THEN (amount-(amount/100*5))*9 
WHEN value='3' THEN (amount-(amount/100*5))*9 
WHEN value='4' THEN (amount-(amount/100*5))*9 
WHEN value='5' THEN (amount-(amount/100*5))*9 
WHEN value='6' THEN (amount-(amount/100*5))*9 
WHEN value='7' THEN (amount-(amount/100*5))*9 
WHEN value='8' THEN (amount-(amount/100*5))*9 
WHEN value='9' THEN (amount-(amount/100*5))*9 END
ELSE 
CASE
WHEN value='green' THEN truncate(((amount-amount/100*5)),2)
