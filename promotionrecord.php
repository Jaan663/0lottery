	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>User Id:<?php echo sprintf("%06d",$userlevel1Result['id']);?></strong></div></div>
            </div>
            </td>
	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>User Id:<?php echo sprintf("%06d",$userlvl2Result['id']);?></strong></div></div>
            </div>
            </td>
