...
.appContent3 {
	background-color: #e0041e !important;
	border-color: #e0041e !important;
	padding:20px;
	font-size:16px;
  ...
  <div class="appContent3 text-white">
    <div class="row">
      <div class="col-12 mb-1">
        ...
        <b>User ID: <?php echo sprintf("%06d",user($con,'mobile',$userid));?>
        </br>
        Available Balance: ₹ <?php echo number_format(wallet($con,'amount',$userid), 2);?>
        </br>
        Total Intrest Earn: ₹ <?php echo (intrest_user($con,'amount',$userid));?></b>
        </div>
...
<div class="card-header">
          <h2 class="mb-0"> 
          <a href="withdrawal.php" class="btn btn-link collapsed fa fa-list-alt text-primary" style="font-size:20px"></i>
           Withdrawal Funds </a> </h2>
          </div>
<p style="color: white; font-size:11px;" ><strong>______________________________________________________________________________</p>
