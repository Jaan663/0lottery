     ...
     <div class="text"><div><strong>Refund</strong><small><?php echo $convert;?></small></div></div>
        ...
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>Bet Refund</strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td class="tdtext">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
...
<!-- Commission  -->
        ...
        <?php }if($actiontype=='first-commission'){?>
        <tr>
          <td>
          <div class="listItem">
          <div class="image">
            ...
            <div class="text"><div><strong>Referral Commission  <?php echo $summeryResult['orderid'] ; ?></strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td class="tdtext">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
...
<!-- Recharge Pending -->
        ...
        <?php }if($actiontype=='recharge-pending'){?>
        <tr>
          <td>
          <div class="listItem">
          <div class="image">
          ...
          <td style="color: orange !important;" class="tdtext">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
...
<!-- Recharge Pending -->
        ...
        <?php }if($actiontype=='recharge-reject'){?>
        <tr>
          <td>
          <div class="listItem">
          <div class="image">
            ...
            <div class="text"><div><strong>Recharge Rejected</strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td style="color: RED !important;" class="tdtext">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
...
<!-- interest -->
        ...
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>Wallet Interest</strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td class="tdtext">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
...
<!-- interest -->
        ...
        <tr>
          <td colspan="2">
          <div class="listItem">
            <div class="text"><div class="text-center"><strong>No transation found...</strong></div></div>
            </div>
            </td>
