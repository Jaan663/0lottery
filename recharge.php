...
<div class="col text-center" style="color:white; font-size: 20px; margin:5px 10px 5px 10px;"><b>Available Balance: ₹ <span id="balance"><?php echo number_format(wallet($con,'amount',$userid), 2); ?></b>
</div>
</div>
...
if ($uid_valid) {
 ...
 <div class="container p-1 border" style="margin-top:5px; background:#3b69a3;">
          <div class="text-center" style="color:white; font-size: 16px;"><b>STEP - 1 <span></b></div>
        </div>
 ...
 <div class="instruction">
        ...
        <ol>
            ...
            <li>Open PhonePe/GPay/PayTm & Any UPI App and send payment VIA UPI. Minimum Recharge Amount is 200₹</li>
            <li>Go back to Recharge page and Submit Payment Amount , 12 Digit UTR number And wait for arrival.</li>
            <li>If any one  not add amount in wallet contact our <a class="instruction" href="#" target="_blank" style="font-style:&quot;bold&quot;;font-weight: bold;color: green;">customer service</a></li>
 ...
 <div class="container p-1 border" style="margin-top:5px; background:#3b69a3;">
          <div class="text-center" style="color:white; font-size: 16px;"><b>STEP - 2 <span></b></div>
        </div>
  ...
  <div class="layout text-center bg-light  d-flex justify-content-center" style="margin-top: 20px; color:white;">
      <a class="btn btn-dark  col text-center" value="200" id="rechamt" name="rechamt" role="button">200</a>
        <a class="btn btn-dark  col text-center" value="300" id="rechamt" name="rechamt" role="button">300</a>
      <a class="btn btn-dark  col text-center" value="500" id="rechamt" name="rechamt" role="button">500</a>
    </div>
<div class="layout text-center bg-light  d-flex justify-content-center" style="margin-top: 20px; color:white;">
      <a class="btn btn-dark col text-center" value="1000" id="rechamt" name="rechamt" role="button">1000</a>
        <a class="btn btn-dark col text-center" value="2000" id="rechamt" name="rechamt" role="button">2000</a>
      <a class="btn btn-dark col text-center" value="5000" id="rechamt" name="rechamt" role="button">5000</a>
 ...
 <div class="container p-1 border" style="margin-top:5px; background:#3b69a3;">
          <div class="text-center" style="color:white; font-size: 16px;"><b>STEP - 3 <span></b></div>
        </div>
