...
<div id="appCapsule" class="pb-2">
  <div class="pb-5">
     <ul class="nav nav-tabs size2" id="myTab3" role="tablist">
        <li class="nav-item"> 
<a class="nav-link active" id="home-tab3" data-toggle="tab" href="#level" role="tab">Level 1</a> 
        </li>
        <li class="nav-item"> 
	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>Mobile No: <?php echo sprintf("%06d",$userlevel1Result['mobile']);?></strong></div></div>
            </div>
            </td>
        ...
        <tr>
          <td colspan="2">
          <div class="listItem">
            <div class="text"><div class="text-center"><strong>No Team Found, Start Sharing and make powerful team.</strong></div></div>
            </div>
            </td>
	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>Mobile No: <?php echo sprintf("%06d",$userlvl2Result['mobile']);?></strong></div></div>
            </div>
            </td>
        ...
        <tr>
          <td colspan="2">
          <div class="listItem">
            <div class="text"><div class="text-center"><strong>Sorry! No Team Found, Start Sharing and make powerful team.</strong></div></div>
            </div>
            </td>
